...
public class SqlLexer extends Lexer {
	...
	private static String[] makeRuleNames() {
		return new String[] {
			...
			"INNER", "LEFT", "RIGHT", "FULL", "OUTER", "ON", "LOGICAL_OPERATOR", 
	...
	private static String[] makeSymbolicNames() {
		return new String[] {
			...
			"OR", "NOT", "LIMIT", "OFFSET", "ORDERBY", "GROUPBY", "ASC", "DESC", 
			"JOIN", "INNER", "LEFT", "RIGHT", "FULL", "OUTER", "ON", "LOGICAL_OPERATOR", 
			"IDENTIFIER", "COMP_OPERATOR", "SEMICOLON", "DOT", "COMMA", "LPAREN", 
			"RPAREN", "NUMBER", "STRING", "ASTERIX", "WS"
		};
	}
